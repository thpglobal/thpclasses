...
/* dynamic property setter/getter for this class */
	...
	public function start($title="THP",$lang="en"){
		...
		echo("<link href='https://fonts.googleapis.com/css?family=Source+Sans+Pro:300|Unna' rel='stylesheet'>\n");
...
<?php
	...
	public function end($message=""){
		...
		echo("<p><a href='https://forms.gle/FB5pkmjGoqG3DpRC9' target='_blank'> Please fill out this form if you are experiencing any functional issues.</a></p>");
		echo("</div>\n");
        echo("</body></html>\n");
    }
}
